...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Termly — School Fee Collection, Payroll & Utility Payments" },
      { name: "description", content: "Termly helps Nigerian schools collect fees, run payroll, and pay utility bills — all powered by Nomba payments." },
